...
class ServerChecker {
	...
	protected function get_reponse_code_description($response_code){
		...
		if (isset($http_codes[$response_code])){
			return $http_codes[$response_code];
		}
		else {
			return "Response code description not available";
		}
